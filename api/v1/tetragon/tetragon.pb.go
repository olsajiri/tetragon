...
func (x *ProcessLoader) GetPid() uint32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
func (x *ProcessLoader) GetTid() uint32 {
	if x != nil {
		return x.Tid
	}
	return 0
...
var file_tetragon_tetragon_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x22, 0x64, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x4c, 0x6f, 0x61,
	0x64, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d,
