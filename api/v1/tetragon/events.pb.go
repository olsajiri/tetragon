...
const (
	...
	EventType_PROCESS_BPF        EventType = 12
...
func (x *GetEventsResponse) GetProcessBpf() *ProcessBpf {
	if x, ok := x.GetEvent().(*GetEventsResponse_ProcessBpf); ok {
		return x.ProcessBpf
	}
	return nil
}
...
type GetEventsResponse_ProcessBpf struct {
	ProcessBpf *ProcessBpf `protobuf:"bytes,12,opt,name=process_bpf,json=processBpf,proto3,oneof"`
}
...
func (*GetEventsResponse_ProcessBpf) isGetEventsResponse_Event() {}
...
var file_tetragon_events_proto_rawDesc = []byte{
	...
	0x22, 0xdd, 0x04, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
	...
	0x12, 0x37, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x62, 0x70, 0x66, 0x18,
	0x0c, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x74, 0x65, 0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e,
	0x2e, 0x50, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x42, 0x70, 0x66, 0x48, 0x00, 0x52, 0x0a, 0x70,
	0x72, 0x6f, 0x63, 0x65, 0x73, 0x73, 0x42, 0x70, 0x66, 0x12, 0x26, 0x0a, 0x04, 0x74, 0x65, 0x73,
	0x74, 0x18, 0xc0, 0xb8, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x74, 0x65, 0x74, 0x72,
	0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x04, 0x74, 0x65, 0x73,
	...
	0x2a, 0x97, 0x01, 0x0a, 0x09, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x09,
	...
	0x43, 0x45, 0x53, 0x53, 0x5f, 0x4c, 0x4f, 0x41, 0x44, 0x45, 0x52, 0x10, 0x0b, 0x12, 0x0f, 0x0a,
	0x0b, 0x50, 0x52, 0x4f, 0x43, 0x45, 0x53, 0x53, 0x5f, 0x42, 0x50, 0x46, 0x10, 0x0c, 0x12, 0x0a,
	0x0a, 0x04, 0x54, 0x45, 0x53, 0x54, 0x10, 0xc0, 0xb8, 0x02, 0x2a, 0x2d, 0x0a, 0x11, 0x46, 0x69,
	...
	0x45, 0x58, 0x43, 0x4c, 0x55, 0x44, 0x45, 0x10, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_tetragon_events_proto_goTypes = []interface{}{
	...
	(*ProcessBpf)(nil),            // 16: tetragon.ProcessBpf
...
var file_tetragon_events_proto_depIdxs = []int32{
	...
	16, // 16: tetragon.GetEventsResponse.process_bpf:type_name -> tetragon.ProcessBpf
...
func file_tetragon_events_proto_init() {
	...
	file_tetragon_events_proto_msgTypes[5].OneofWrappers = []interface{}{
		...
		(*GetEventsResponse_ProcessBpf)(nil),
