...
type ProcessUprobe struct {
	...
	Args    []*KprobeArgument `protobuf:"bytes,5,rep,name=args,proto3" json:"args,omitempty"`
}
...
var file_tetragon_tetragon_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0xc1, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x63,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x79, 0x6d, 0x62, 0x6f, 0x6c, 0x12, 0x2c, 0x0a,
	0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x74, 0x65,
	0x74, 0x72, 0x61, 0x67, 0x6f, 0x6e, 0x2e, 0x4b, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x41, 0x72, 0x67,
...
var file_tetragon_tetragon_proto_depIdxs = []int32{
	...
	23, // 61: tetragon.ProcessUprobe.args:type_name -> tetragon.KprobeArgument
	1,  // 62: tetragon.GetHealthStatusRequest.event_set:type_name -> tetragon.HealthStatusType
	1,  // 63: tetragon.HealthStatus.event:type_name -> tetragon.HealthStatusType
	2,  // 64: tetragon.HealthStatus.status:type_name -> tetragon.HealthStatusResult
	29, // 65: tetragon.GetHealthStatusResponse.health_status:type_name -> tetragon.HealthStatus
	9,  // 66: tetragon.ProcessLoader.process:type_name -> tetragon.Process
	34, // 67: tetragon.RuntimeHookRequest.createContainer:type_name -> tetragon.CreateContainer
	36, // 68: tetragon.CreateContainer.annotations:type_name -> tetragon.CreateContainer.AnnotationsEntry
