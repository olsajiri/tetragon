...
static inline __attribute__((always_inline)) int data_event(
	void *ctx, struct data_event_desc *desc, unsigned long uptr, size_t size,
...
data_event_bytes(void *ctx, struct data_event_desc *desc, unsigned long uptr, size_t size,
		 struct bpf_map_def *heap)
{
