...
// PreparePacket validates a record and replaces its process identity with
// the authenticated PID of the Unix control-socket peer.
func PreparePacket(data []byte, peerPID uint32) error {
	...
	binary.LittleEndian.PutUint32(data[16:20], peerPID)
