...
func AddFlags(flags *pflag.FlagSet) {
	...
	flags.String(KeyJavaIPCPath, defaults.DefaultJavaSocket, "Unix socket for Java monitoring agent shared-memory ring registration. An empty path disables Java IPC.")
