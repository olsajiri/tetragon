...
`,
	...
	flags.StringVar(&cfg.lib, "bpf-lib", "?", "Location of Tetragon libs, btf and bpf files, '?' to auto detect")
	flags.StringVar(&cfg.bpffs, "bpf-dir", "?", "Location of bpffs tetragon directory, '?' to auto detect")
